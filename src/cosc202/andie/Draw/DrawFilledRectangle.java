 ...
 * @version 1.0
 */
public class DrawFilledRectangle implements ImageOperation, java.io.Serializable  {
    ...
    public DrawFilledRectangle(Color outline, Color fill, int thickness, ImagePanel target) {
