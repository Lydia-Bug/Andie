...
- Accessed via: Transformations menu (Options for flipping horizontally or vertically). Keyboard shortcut - Ctrl-Right for vertical flip, Ctr-Down for horizontal flip. 
